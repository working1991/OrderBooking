...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat y = (CGRectGetHeight(rect) - [XHSegmentItem caculateTextHeight:self.title withFont:self.titleFont])/2;//(CGRectGetHeight(self.frame) - self.titleFont.pointSize)/2;
...
{
    CGFloat width = Item_Padding * 2 + [XHSegmentItem caculateTextWidth:title withFont:titleFont]+20;
...
+ (CGFloat)caculateTextHeight:(NSString *)text withFont:(UIFont *)font
{
