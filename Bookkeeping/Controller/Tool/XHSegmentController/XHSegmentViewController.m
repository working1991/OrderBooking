...
//        if (!self.navigationController) {
            CGFloat y = !self.navigationController?0:64;
...
//
//        } else {
//            UIView *titleView = [[UIView alloc] initWithFrame:CGRectMake(10, 7, Screen_Full_Width-80*2, DefaultSegmentHeight)];
//            _segmentControl = [[XHSegmentControl alloc] initWithFrame:CGRectMake(0, 0, titleView.bounds.size.width, DefaultSegmentHeight)];
